...
define(["N/record", "N/file", "N/email", "N/encode", "N/search", "N/https", "N/log"],
    function (record, file, email, encode, search, https, log) {
        ...
        function send(plugInContext) {
            ...
            try {
                var internalId = plugInContext.transaction.id;
                var userId = plugInContext.sender.id;
        ...
        function createRequest(documentid, array) {
            ...
            try {
                ...
                var detail = getDetail(documentid, array);
                ...
                jsonCAB.montoTotalImpuestos = detail.montototalimpuestos.toString();
        ...
        function getDetail(documentid, array) {
            var json = new Array();
            ...
            try {
                ...
                for (var i = 0; i < linecount; i++) {
                    ...
                    //var line = openRecord.getSublistValue({ sublistId: 'item', fieldId: 'line', line: i });
                ...
                logError(array[0], array[1], 'Error-getDetail', e.message);
            }
        }
        ...
        //                 // impuesto = rate * (taxrate1 / 100);
        //                 // precioVentaUnitario = parseFloat(rate) + parseFloat(impuesto.toFixed(2));
        //                 // precioVentaUnitario = precioVentaUnitario.toFixed(2);
        //                 precioVentaUnitario = tax1amt + amount
        ...
        //                     codigocargocescuento = '03'; // Descuentos globales que no afectan la base imponible del IGV
        //                 }
        //                 factorcargodescuento = Math.abs(rate) / 100;
        //                 montocargodescuento = Math.abs(amount) * factorcargodescuento;
        //                 montocargodescuento = montocargodescuento.toFixed(2);
        //                 montobasecargodescuento = Math.abs(amount);
        //                 factorcargodescuento = factorcargodescuento.toFixed(2);

        //                 jsonCargoDescuento.push({
        //                     indicadorCargoDescuento: indicadorcargodescuento,
        //                     codigoCargoDescuento: codigocargocescuento,
        //                     factorCargoDescuento: factorcargodescuento.toString(),
        //                     montoCargoDescuento: montocargodescuento.toString(),
        //                     montoBaseCargoDescuento: montobasecargodescuento.toString()
        //                 });
        //             }
        //         }
        ...
        //         return jsonReturn;
        //     } catch (e) {
        //         logError(array[0], array[1], 'Error-getDetailCreditMemo', e);
        //     }
        // }
        ...
        function setRecord(recordtype, internalid, tranid, urlpdf, urlxml, urlcdr, urljson, encodepdf, array) {
            try {
                if (recordtype != '') {
                    var recordload = record.load({ type: record.Type.INVOICE, id: internalid });
                } else {
                    var recordload = record.load({ type: record.Type.CREDIT_MEMO, id: internalid });
                }

                recordload.setValue('custbody_pe_fe_ticket_id', tranid);
                recordload.setValue('custbody_pe_ei_printed_xml_request', urljson);
                recordload.setValue('custbody_pe_ei_printed_xml_response', urlxml);
                recordload.setValue('custbody_pe_ei_printed_cdr_response', urlcdr);
