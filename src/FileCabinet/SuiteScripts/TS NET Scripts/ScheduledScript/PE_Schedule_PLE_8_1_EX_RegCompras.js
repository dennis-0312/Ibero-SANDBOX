...
define(['N/search', 'N/record', 'N/email', 'N/runtime', 'N/log', 'N/file', 'N/task', "N/config"],
    function (search, record, email, runtime, log, file, task, config) {
        function execute(context) {
            ...
            perLookup = perLookup.periodname;
            //fedIdNumb = fedIdNumb.value;
            ...
            try {
                ...
                for (i; i < result.length; i++) {
                    ...
                    campoRegistro17 = parseFloat(campoRegistro17).toFixed(2);
                    var campoRegistro18 = result[i].getValue(searchLoad.columns[17]);
                    campoRegistro18 = parseFloat(campoRegistro18).toFixed(2);
                    var campoRegistro19 = result[i].getValue(searchLoad.columns[18]);
                    campoRegistro19 = parseFloat(campoRegistro19).toFixed(2);
                    var campoRegistro20 = result[i].getValue(searchLoad.columns[19]);
                    campoRegistro20 = parseFloat(campoRegistro20).toFixed(2);
                    var campoRegistro21 = result[i].getValue(searchLoad.columns[20]);
                    campoRegistro21 = parseFloat(campoRegistro21).toFixed(2);
                    var campoRegistro22 = result[i].getValue(searchLoad.columns[21]);
                    campoRegistro22 = parseFloat(campoRegistro22).toFixed(2);
                    var campoRegistro23 = result[i].getValue(searchLoad.columns[22]);
                    campoRegistro23 = parseFloat(campoRegistro23).toFixed(2);
                    ...
                    campoRegistro26 = Number(campoRegistro26).toFixed(3);
                    ...
                    if ((campoRegistro06 == '01' || campoRegistro06 == '14') && (campoRegistro01 == periodoEmision)) {
                        campoRegistro42 = '1';
                    } else if ((campoRegistro06 != '01' || campoRegistro06 != '14' || campoRegistro06 != '10' || campoRegistro06 != '03') && (campoRegistro01 == periodoEmision)) {
                        campoRegistro42 = '0';
                    } else if ((campoRegistro06 == '01' || campoRegistro06 == '07' || campoRegistro06 == '14') && (campoRegistro01 != periodoEmision)) {
                        campoRegistro42 = '6';
                    } else if ((campoRegistro06 != '01' || campoRegistro06 != '07' || campoRegistro06 != '14' || campoRegistro06 != '10' || campoRegistro06 != '03') && (campoRegistro01 != periodoEmision)) {
                        campoRegistro42 = '7';
                    }
                ...
                var nameReportGenerated = 'LE' + fedIdNumb + retornaPeriodoString(perLookup) + '080100' + '00' + '1111_ex' + '_' + filterPage;
                ...
                if (i == 1000) {
                    ...
                    if (filterArchivosGen == fileId) {
                        ...
                        var nameReportGenerated_N = 'LE' + fedIdNumb + retornaPeriodoString(perLookup) + '080100' + '00' + '1' + tieneInfo + '11_' + filterArchivosGen;
                        if (filterFormat == 'CSV') {
                        ...
                        if (filesCreados.length <= corteRegistros) {
                            ...
                            var nameReportGenerated_N = 'LE' + fedIdNumb + retornaPeriodoString(perLookup) + '080100' + '00' + '1' + tieneInfo + '11_' + correlativoFile;
                            if (filterFormat == 'CSV') {
                                contentFile = contentFile.replace(/\|/g, ',');
                                //contentFile = cabeceraCSV + contentFile;
                            }
                            if (filterFormat == 'TXT' && i != 0) contentFile += '|';
                            ...
                            var nameReportGenerated_N2 = 'LE' + fedIdNumb + retornaPeriodoString(perLookup) + '080100' + '00' + '1' + tieneInfo + '11_' + fileId2; // AGREGADO POR JEAN ÑIQUE
                            var fileAux = file.load({
                       ...
                       id: recordIdAux,
                            ...
                            for (var i = 0; i < filesCreados.length; i++) {
                                ...
                                if ((i + 1) % corteRegistros == 0 || (i + 1) == filesCreados.length) {
                                    var nameReportGenerated_N = 'LE' + fedIdNumb + retornaPeriodoString(perLookup) + '080100' + '00' + '1' + tieneInfo + '11_' + correlativoFile + '(' + cuentaRegistroCreado + ')';
                                    if (filterFormat == 'CSV') {
                                        contentFile = contentFile.replace(/\|/g, ',');
                                        //contentFile = cabeceraCSV + contentFile;
                                    }
